...
//			pst.execute();
	...
	public List<BeanPublisher> searchPublisher(String keyword) throws BaseException {
		...
		try {
			conn = DBUtil.getConnection();
			String sql = "select pubid,publisherName,address from BeanPublisher where publisherName like ? or address like ?";
			java.sql.PreparedStatement pst = conn.prepareStatement(sql);
	...
	public static void main(String[] args) {
		BeanPublisher p = new BeanPublisher();
		p.setPubid("test_pid");
		p.setPublisherName("test_name");
		p.setAddress("test_address");
